...
- required_technologies — явно обязательные. Маркеры в тексте: "требуется", "обязательно","уверенный опыт", "необходимо знание", "опыт работы с", "уверенные знания", основной тех-стек в заголовке/первых строках требований.
