...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "cv_id", sa.Integer(), sa.ForeignKey("cvs.id"), nullable=False, index=True
        ),
        ...
        sa.Column(
            "model_used", sa.String(length=100), nullable=False, server_default="gpt-4o"
        ),
        sa.Column(
            "status", sa.String(length=50), nullable=False, server_default="generated"
        ),
        sa.Column(
